        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                && textBox3.Text.Trim() != "")
            {
                try
                {
                    ...
                    string consulta = "insert into cliente (rut,nombre,direccion,telefono) values ('" + maskedTextBox1.Text + "','" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "')";
                    ...
                    string consulta2 = "select * from cliente";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
                ...
                && textBox3.Text.Trim() != "")
            {
                try
                {
                    ...
                    string consulta = "update cliente set rut = '" + maskedTextBox1.Text + "' ,nombre ='" + textBox1.Text + "', direccion = '" + textBox2.Text + "', telefono = '" + textBox3.Text + "' where rut = '" + maskedTextBox1.Text + "'";
